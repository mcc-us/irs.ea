...
function buttonPubs() { window.open("https://www.irs.gov/forms-pubs"); }
...
- **Not in this publication**  <button onclick="button2()">Open: irs-pubs</button> 
...
<script> function button10() { window.open("/irs.ea/assets/pdfs/i8936.pdf"); } </script>
1. Clean vehicle credit (New): Use Form 8936 & and Schedule A (Form 8936) & 1040-Schedule 3, line 6f:  <button onclick="button2()">Open: irs-pubs</button> 
...
- **Schedule 3-1040 Add'ns**  <button onclick="button2()">Open: irs-pubs</button> 
...
- Self-employed health insurance deduction:  <button onclick="button2()">Open: irs-pubs</button> 
  - Use Form 7206, report on 1040 Schedule 1, line 17

- 1X Charitable distribution: 2023 **-->** distribute < \$50K from IRA

- Increase required minimum distribution age **-->** 72yr  <button onclick="button2()">Open: irs-pubs</button> 
  - Use Pub. 590–B
...
- Deferred compensation contribution (401(k), 403(b),fed gov Thrift Savings Plan) increased: **-->** $\gt$ \$22.5 K (\$30 K, if $\gt$ \$50 yr), also for most 457 plans  <button onclick="button2()">Open: irs-pubs</button> 
...
- Diaster tax relief - See Disaster-Related Relief in Pub. 590-B   <button onclick="button2()">Open: irs-pubs</button> 

- Distributions to terminally ill individuals. The exception to the 10% additional tax for early distributions is expanded to distributions made after 12/29/2022, to a certified individual. See Pub. 590-B  <button onclick="button2()">Open: irs-pubs</button> 
...
- Change of address: Form 8822  <button onclick="button2()">Open: irs-pubs</button> 
...
- Automatic 6-month extension: Form 4868  <button onclick="button2()">Open: irs-pubs</button> 
...
- Doesn't have & isn't eligible to get a social security number, **Use/file Form W-7**  <button onclick="button2()">Open: irs-pubs</button> 
...
- Community property states: 
  ...
  1. Schedule F-Form 1040  <button onclick="button2()">Open: irs-pubs</button> 
  1. Include Arizona, California,Idaho, Louisiana, Nevada, New Mexico, Texas, Washington & Wisconsin

<br>

- Self-employed individuals
  1. SEE: line 7 of Schedule C (Form 1040) Profit or Loss From Business & line 9  <button onclick="button2()">Open: irs-pubs</button> 
...
- U.S. Citizens & Resident Aliens Living Abroad:
  1. Pub. 54, *Tax Guide for U.S. Citizens and Resident Aliens Abroad*  <button onclick="button2()">Open: irs-pubs</button> 
  1. See Tables 1-1,2,3

<br>

- Residents of Puerto Rico, Guam, The Northern Mariana Islands, American Samoa, or the U.S. Virgin Islands
  1. Pub. 570  <button onclick="button2()">Open: irs-pubs</button> 
  1. See Table 1-1,3
...
- Children < 19yr or FT Students: 
  1. Form 8814 <button onclick="button2()">Open: irs-pubs</button> 
  ...
  1. The child can choose to lump income together:
      1. See: i8814, *Parents Election To Report Child’s Interest & Dividends*  <button onclick="button2()">Open: irs-pubs</button> 

<br>

- Self-Employed: *Pub. 334, Tax Guide for Small Business (Schedule C)*  <button onclick="button2()">Open: irs-pubs</button> 
...
- Ministers: Pub. 517, Like Self-employed  <button onclick="button2()">Open: irs-pubs</button> 

<br>

- Aliens: Pub. 519, *Tax Guide for Aliens*  <button onclick="button2()">Open: irs-pubs</button> 
...
- 1.9 Who Should File: See Pub. 596, 970, 974  <button onclick="button2()">Open: irs-pubs</button> 
...
- Requirements for an Electronic filing & returns
  ...
  - 1.14 Form 8453  <button onclick="button2()">Open: irs-pubs</button> 
...
## APPENDIX: Publications & Forms Mentioned
 ...
 <button onclick="button2()">Open: irs-pubs</button> 
