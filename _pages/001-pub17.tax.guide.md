...
> For IRS Video Information:  
> [IRS YouTube](https://www.youtube.com/@irsvideos)  
{: .block-tip }  
...
3. See [IRS Video, 1 hr](https://www.youtube.com/watch?v=DtYufJmdm1A)
...
|Problem|
|-|
|\$6,500 (\$7,500 for individuals $\gt$ 50 yr)<br>from \$6,000 (\$7,000 for individuals $\gt$ 50 yr)**|

<hr class="red">

- Deferred compensation contribution (401(k), 403(b),fed gov Thrift Savings Plan) increased:<br>  $\gt$ \$22.5 K ( \$30 K, if $\gt$ \$50 yr), also for most 457 plans  <button onclick="buttonPubs()">Open: irs-pubs</button> 
...
|When To File|
|:-:|
|![Table 1.5](/assets/images/images.pub.17/table.1.5.png)|
...
- **6 Step of How to File**  
  1. Get all records  
  1. Get forms, schedules, publications  
  1. Fill in return  
  1. Check return  
  1. Sign and Date return  
  1. Attach all req'd forms & schedules  
