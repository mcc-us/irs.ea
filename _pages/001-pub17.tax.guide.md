...
1. Clean vehicle credit (New): Use Form 8936 & and Schedule A (Form 8936) & 1040-Schedule 3, line 6f:  <button onclick="buttonPubs()">Open: irs-pubs</button> 
...
- Community property states: 
  ...
  1. Schedule F-Form 1040  <button onclick="buttonPubs()">Open: irs-pubs</button> 
  1. Include Arizona, California,Idaho, Louisiana, Nevada, New Mexico, Texas, Washington & Wisconsin

<br>

- Self-employed individuals
  1. SEE: line 7 of Schedule C (Form 1040) Profit or Loss From Business & line 9  <button onclick="buttonPubs()">Open: irs-pubs</button> 
...
- U.S. Citizens & Resident Aliens Living Abroad:
  1. Pub. 54, *Tax Guide for U.S. Citizens and Resident Aliens Abroad*  <button onclick="buttonPubs()">Open: irs-pubs</button> 
...
- Children < 19yr or FT Students: 
  1. Form 8814 <button onclick="buttonPubs()">Open: irs-pubs</button> 
  ...
  1. The child can choose to lump income together:
      1. See: i8814, *Parents Election To Report Child’s Interest & Dividends*  <button onclick="buttonPubs()">Open: irs-pubs</button> 
